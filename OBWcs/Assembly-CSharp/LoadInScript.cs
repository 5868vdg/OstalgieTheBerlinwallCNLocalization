...
{
	// Token: 0x0600008E RID: 142 RVA: 0x00002800 File Offset: 0x00000A00
	public bool from_string(string str)
	{
		return str == "True";
	}

	// Token: 0x0600008F RID: 143 RVA: 0x0000280D File Offset: 0x00000A0D
	private void Awake()
	{
		this.global1 = GameObject.Find("Global(Clone)").GetComponent<GlobalScript>();
	}

	// Token: 0x06000090 RID: 144 RVA: 0x000321EC File Offset: 0x000303EC
	private void OnMouseDown()
	{
		...
		if (PlayerPrefs.HasKey("g6" + this.number.ToString()))
		{
			...
			{
				this.global1.data_old[i] = PlayerPrefs.GetInt("D_old" + i.ToString() + this.number.ToString());
			}
			for (int j = 0; j < this.global1.data.Length; j++)
			{
				this.global1.data[j] = PlayerPrefs.GetInt("data" + j.ToString() + this.number.ToString());
			}
			...
			for (int k = 0; k < 5; k++)
			{
				...
				for (int l = 0; l < 15; l++)
				{
					...
					this.global1.regions[k].buildings[l].type = PlayerPrefs.GetInt(string.Concat(new object[] { "t11", k, l, this.number }));
					this.global1.regions[k].city_level = PlayerPrefs.GetInt("l12" + k.ToString() + this.number.ToString());
				}
			}
			for (int m = 0; m < this.global1.allcountries.Length; m++)
			{
				...
				this.global1.allcountries[m].Westalgie = PlayerPrefs.GetInt("Wes" + m.ToString() + this.number.ToString());
				this.global1.allcountries[m].Gosstroy = PlayerPrefs.GetInt("Gos" + m.ToString() + this.number.ToString());
				this.global1.allcountries[m].subideology = PlayerPrefs.GetInt("Sub" + m.ToString() + this.number.ToString());
			}
			this.global1.allcountries[17].Westalgie = PlayerPrefs.GetInt("Wes" + 17.ToString() + this.number.ToString());
			this.global1.allcountries[40].Westalgie = PlayerPrefs.GetInt("Wes" + 40.ToString() + this.number.ToString());
			this.global1.allcountries[41].Westalgie = PlayerPrefs.GetInt("Wes" + 41.ToString() + this.number.ToString());
			this.global1.allcountries[42].Westalgie = PlayerPrefs.GetInt("Wes" + 42.ToString() + this.number.ToString());
			this.global1.allcountries[43].Westalgie = PlayerPrefs.GetInt("Wes" + 43.ToString() + this.number.ToString());
			this.global1.allcountries[44].Westalgie = PlayerPrefs.GetInt("Wes" + 44.ToString() + this.number.ToString());
			this.global1.allcountries[45].Westalgie = PlayerPrefs.GetInt("Wes" + 45.ToString() + this.number.ToString());
			this.global1.allcountries[46].Westalgie = PlayerPrefs.GetInt("Wes" + 46.ToString() + this.number.ToString());
			this.global1.allcountries[47].Westalgie = PlayerPrefs.GetInt("Wes" + 47.ToString() + this.number.ToString());
			for (int n = 1; n < 8; n++)
			{
				this.global1.allcountries[n].paths = PlayerPrefs.GetInt("Cou" + n.ToString() + this.number.ToString());
			}
			...
			{
				this.global1.Events_number[num2] = PlayerPrefs.GetInt("E_num" + num2.ToString() + this.number.ToString());
				this.global1.Events_time[num2] = PlayerPrefs.GetFloat("E_tim" + num2.ToString() + this.number.ToString());
				...
				this.global1.eventVariantChosen[num2] = PlayerPrefs.GetInt("E_variant" + num2.ToString() + this.number.ToString());
			}
			...
			this.global1.issleduetsya = PlayerPrefs.GetInt("issled" + this.number.ToString());
			...
			for (int num3 = 0; num3 < this.global1.party_number.Length; num3++)
			{
				...
				this.global1.party_number[num3] = PlayerPrefs.GetInt("P_num" + num3.ToString() + this.number.ToString());
				this.global1.party_ideology[num3] = PlayerPrefs.GetInt("P_ideo" + num3.ToString() + this.number.ToString());
			...
			for (int num8 = 0; num8 < this.global1.science.Length; num8++)
			{
				...
				this.global1.science_time[num8] = PlayerPrefs.GetInt("S_time" + num8.ToString() + this.number.ToString());
			}
	...
	// Token: 0x06000091 RID: 145 RVA: 0x00033630 File Offset: 0x00031830
	...
	// Token: 0x06000092 RID: 146 RVA: 0x00033868 File Offset: 0x00031A68
	private void OnMouseEnter()
	{
		if (PlayerPrefs.GetInt("language") == 0)
		{
			...
			if (PlayerPrefs.HasKey("g6" + this.number.ToString()))
			{
				...
				opis2.text = opis2.text + "\n 国 家: " + PlayerPrefs.GetString("n6" + this.number.ToString());
	...
	// Token: 0x06000093 RID: 147 RVA: 0x00002824 File Offset: 0x00000A24
