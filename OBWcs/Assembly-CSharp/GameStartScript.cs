...
{
	// Token: 0x06000077 RID: 119 RVA: 0x0002ED34 File Offset: 0x0002CF34
	private void InDLCCheck()
	{
		if ((this.number == 49 || this.number == 50 || this.number == 51) && this.is_active[2])
		{
			...
			{
				global::UnityEngine.Object.Instantiate<GameObject>(this.yug);
				global::UnityEngine.Object.DontDestroyOnLoad(GameObject.Find("Yugoglobal(Clone)"));
			}
			if (this.is_active[2])
			{
				...
				else
				{
					...
					component.gameState.modifies[26] = 1;
		...
		if (this.is_active[3])
		{
			if (this.global1.allcountries[7].paths == 1)
			{
				...
				{
					this.global1.allcountries[7].paths = global::UnityEngine.Random.Range(0, 5);
				}
				Debug.Log("Путь 7: " + this.global1.allcountries[7].paths.ToString());
			}
			...
			if (this.global1.allcountries[1].paths == 1)
			{
				...
				{
					this.global1.allcountries[1].paths = global::UnityEngine.Random.Range(0, 6);
				}
				Debug.Log("Путь 1: " + this.global1.allcountries[1].paths.ToString());
			}
			...
			if (this.global1.allcountries[2].paths == 1)
			{
				...
				{
					this.global1.allcountries[2].paths = global::UnityEngine.Random.Range(0, 5);
				}
				Debug.Log("Путь 2: " + this.global1.allcountries[2].paths.ToString());
			}
			...
			if (this.global1.allcountries[3].paths == 1)
			{
				...
				{
					this.global1.allcountries[3].paths = global::UnityEngine.Random.Range(0, 6);
				}
				Debug.Log("Путь 3: " + this.global1.allcountries[3].paths.ToString());
			}
			...
			if (this.global1.allcountries[4].paths == 1)
			{
				...
				{
					this.global1.allcountries[4].paths = global::UnityEngine.Random.Range(0, 6);
				}
				Debug.Log("Путь 4: " + this.global1.allcountries[4].paths.ToString());
			}
			...
			if (this.global1.allcountries[5].paths == 1)
			{
				...
				{
					this.global1.allcountries[5].paths = global::UnityEngine.Random.Range(0, 6);
				}
				Debug.Log("Путь 5: " + this.global1.allcountries[5].paths.ToString());
			}
			...
			if (this.global1.allcountries[6].paths == 1)
			{
				...
				{
					this.global1.allcountries[6].paths = global::UnityEngine.Random.Range(0, 6);
				}
				Debug.Log("Путь 6: " + this.global1.allcountries[6].paths.ToString());
			}
			...
			if (PlayerPrefs.GetInt("language") == 0)
			{
				...
				{
					this.global1.sovietPremiereName = " 雅 科 夫 列 夫";
					return;
				}
				if (this.global1.allcountries[7].paths == 3)
				{
					this.global1.sovietPremiereName = " 沃 罗 特 尼 科 夫";
					return;
				}
				this.global1.sovietPremiereName = " 戈 尔 巴 乔 夫";
				return;
			}
			else
			{
	...
	// Token: 0x06000078 RID: 120 RVA: 0x0002F62C File Offset: 0x0002D82C
	private void subIdeologyCheck()
	{
		...
		this.global1.allcountries[5].subideology = 0;
		...
		this.global1.allcountries[43].subideology = 12;
		this.global1.allcountries[44].subideology = 14;
		this.global1.allcountries[45].subideology = 9;
		this.global1.allcountries[46].subideology = 10;
	...
	// Token: 0x06000079 RID: 121 RVA: 0x0002FA74 File Offset: 0x0002DC74
	private void OnMouseDown()
	{
		if (this.number == 38 || this.number == 1 || this.number == 2 || this.number == 5 || this.number == 6 || ((this.number == 10 || this.number == 12 || this.number == 18) && this.is_active[1]) || ((this.number == 3 || this.number == 4 || this.number == 20) && this.is_active[0]) || ((this.number == 49 || this.number == 50 || this.number == 51) && this.is_active[2]))
		{
			if (PlayerPrefs.GetInt("language") == 0)
			{
				this.global1.sovietPremiereName = " 戈 尔 巴 乔 夫";
			...
			TextAsset textAsset = Resources.Load(string.Format("{0}_text/new_texts", text)) as TextAsset;
			...
			{
				this.global1.allcountries[44].Donat = true;
			}
			if (PlayerPrefs.GetInt("language") == 0)
			{
			...
			string text12 = textAsset.text;
			Resources.UnloadAsset(textAsset);
			array = text12.Split(new char[] { ';' });
			for (int num18 = 0; num18 < array.Length; num18++)
			{
				this.global1.science[num18] = array[num18] == "1";
			}
			this.global1.data[49] = global::UnityEngine.Random.Range(1, 5);
			this.global1.data[48] = global::UnityEngine.Random.Range(1, 5);
			this.global1.data[47] = global::UnityEngine.Random.Range(1, 5);
			...
			else if (this.global1.data[0] == 12)
			{
				...
				for (int num19 = 114; num19 < 126; num19++)
				{
					...
					{
						this.global1.data[num19] = global::UnityEngine.Random.Range(60, 85);
					}
					else if (this.global1.data[num19 - 1] > 80)
					{
						this.global1.data[num19] = global::UnityEngine.Random.Range(60, 80);
					}
					else if (this.global1.data[num19 - 1] > 75)
					{
						this.global1.data[num19] = global::UnityEngine.Random.Range(60, 75);
					}
					else if (this.global1.data[num19 - 1] > 70)
					{
						this.global1.data[num19] = global::UnityEngine.Random.Range(60, 70);
					}
					else
					{
						this.global1.data[num19] = global::UnityEngine.Random.Range(70, 90);
					}
				}
			}
			this.global1.allcountries[5].Gosstroy = 9;
			this.global1.allcountries[13].Gosstroy = 1;
			this.global1.allcountries[32].Gosstroy = 9;
			this.global1.allcountries[38].Gosstroy = 2;
			if (this.global1.data[0] == 1 || this.global1.data[0] == 2 || this.global1.data[0] == 3 || this.global1.data[0] == 6 || this.global1.data[0] == 18)
			{
				this.global1.data[232] = 4;
				this.global1.allcountries[this.global1.data[0]].subideology = 4;
			}
			else if (this.global1.data[0] == 4)
			{
				this.global1.data[232] = 8;
				this.global1.allcountries[this.global1.data[0]].subideology = 8;
			}
			else if (this.global1.data[0] == 5 || this.global1.data[0] == 10 || this.global1.data[0] == 12)
			{
				this.global1.data[232] = 16;
				this.global1.allcountries[this.global1.data[0]].subideology = 0;
			}
			else if (this.global1.data[0] == 20)
			{
				this.global1.data[232] = 7;
				this.global1.allcountries[this.global1.data[0]].subideology = 7;
			}
			if (this.global1.data[5] <= 300)
			{
			...
			else if (this.global1.data[5] <= 850)
			{
	...
	// Token: 0x0600007A RID: 122 RVA: 0x000313A0 File Offset: 0x0002F5A0
	public void Repaint()
	{
		if (PlayerPrefs.GetInt("language") == 0)
		{
			...
			{
				this.ach_text.text = " 无 法 解 锁 成 就";
				return;
			}
			...
			{
				this.ach_text.text = " 仅 特 殊 成 就";
				return;
			}
			this.ach_text.text = " 可 解 锁 成 就";
			return;
		}
		else
		{
	...
	// Token: 0x0600007B RID: 123 RVA: 0x00031594 File Offset: 0x0002F794
	private void Awake()
	{
		...
		{
			this.ach_text.text = " 无 法 解 锁 成 就";
			this.usl2.text = " 来 自 莫 斯 科 的 压 力";
			this.usl3.text = " 西 方 宣 传";
			this.usl1.text = " 党 内 腐 败";
			this.start.text = " 开 始";
			this.exit.text = " 退 出";
		}
		this.Checking_dlc01();
	...
	// Token: 0x0600007C RID: 124 RVA: 0x00031654 File Offset: 0x0002F854
	public void Checking_dlc01()
	{
		try
		{
			if (Application.platform == RuntimePlatform.WindowsPlayer)
			{
				if (File.Exists(Application.dataPath + "\\hoxha".ToString() + ".txt"))
				{
					...
					this.okno_dlc[0].text_en = "\" 霍 查 的 遗 产\"  已 激 活";
					this.okno_dlc[0].text = "\"Наследие Ходжи\" активировано";
				}
				else
				{
					this.is_active[0] = false;
					this.okno_dlc[0].text_en = " 匈 牙 利 ， 捷 克 斯 洛 伐 克 和 阿 尔 巴 尼 亚\n 需 要DLC \" 霍 查 的 遗 产\"";
				...
				if (File.Exists(Application.dataPath + "\\lefty".ToString() + ".txt"))
				{
					...
					this.okno_dlc[1].text_en = "\" 铁 幕 之 殒\"\n 已 激 活";
					this.okno_dlc[1].text = "\"Падение Занавеса\"\nактивировано";
				}
				else
				{
					this.is_active[1] = false;
					this.okno_dlc[1].text_en = " 朝 鲜 ， 古 巴 和 阿 富 汗\n 需 要DLC \" 铁 幕 之 殒\"";
				...
				if (File.Exists(Application.dataPath + "\\bigb".ToString() + ".txt"))
				{
					...
					this.okno_dlc[2].text_en = "\" 南 斯 拉 夫 之 乱\"\n 已 激 活";
					this.okno_dlc[2].text = "\"Раздор в Югославии\"\nактивировано";
				}
				else
				{
					this.is_active[2] = false;
					this.okno_dlc[2].text_en = " 南 斯 拉 夫 国 家\n 需 要DLC \" 南 斯 拉 夫 之 乱\" ";
				...
				if (File.Exists(Application.dataPath + "\\pmod".ToString() + ".txt"))
				{
					...
					this.okno_dlc[3].text_en = "\" 历 史 之 路\"\n 已 激 活";
					this.okno_dlc[3].text = "\"Пути истории\"\nактивировано";
				}
				else
				{
					this.is_active[3] = false;
					this.okno_dlc[3].text_en = " 国 家 路 线\n 需 要DLC \" 历 史 之 路\"";
		...
		catch
		{
			...
			this.okno_dlc[3].text_en = " 国 家 路 线\n 需 要DLC \" 历 史 之 路\"";
			this.okno_dlc[3].text = "Для путей стран\nнужно ДЛЦ \"Пути истории\"";
			this.BoxDLC[3].SetActive(false);
		}
	}

	// Token: 0x0600007D RID: 125 RVA: 0x0000271F File Offset: 0x0000091F
	...
	// Token: 0x0600007E RID: 126 RVA: 0x0000273B File Offset: 0x0000093B
