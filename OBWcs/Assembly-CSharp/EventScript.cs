...
{
	// Token: 0x06000065 RID: 101 RVA: 0x00002567 File Offset: 0x00000767
	private void Awake()
	{
	...
	// Token: 0x06000067 RID: 103 RVA: 0x000025B2 File Offset: 0x000007B2
	private void OnMouseExit()
	{
		base.GetComponent<SpriteRenderer>().sprite = this.off;
	}

	// Token: 0x06000068 RID: 104 RVA: 0x0002BFB0 File Offset: 0x0002A1B0
	...
	// Token: 0x06000069 RID: 105 RVA: 0x0002C010 File Offset: 0x0002A210
	...
	// Token: 0x0600006A RID: 106 RVA: 0x0002C06C File Offset: 0x0002A26C
	...
	// Token: 0x0600006B RID: 107 RVA: 0x0002C0C4 File Offset: 0x0002A2C4
	private void Update()
	{
		if (this.global1.speed != 0)
		{
			...
			if (this.time <= 0.1f)
			{
				...
				else if (this.global1.number_event == 315)
				{
					this.global1.number_otvet = 3;
				}
				...
				else if (this.global1.number_event == 280)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 282)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 286)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 288)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 289)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 298)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 299)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 301)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 302)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event >= 303 && this.global1.number_event <= 310)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event >= 319 && this.global1.number_event <= 320)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 321)
				{
					this.global1.number_otvet = 6;
				}
				else if (this.global1.number_event == 324)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 329)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 330)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 331)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 333)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 334)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 335)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 339)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 340)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 343)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event >= 346 && this.global1.number_event <= 348)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 349)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 350)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event >= 351 && this.global1.number_event <= 353)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 357)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 358)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 360)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 362)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 363)
				{
					this.global1.number_otvet = 6;
				}
				else if (this.global1.number_event == 366)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 372)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 374)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 379)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 383)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 384)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 385)
				{
					this.global1.number_otvet = 5;
				}
				else if (this.global1.number_event == 387)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 388)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 390)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 392)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 394)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 396)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 397)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 401)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 404)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 405)
				{
					this.global1.number_otvet = 1;
				}
				else if (this.global1.number_event == 406)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 428)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 429)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 430)
				{
					this.global1.number_otvet = 5;
				}
				else if (this.global1.number_event == 433)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 434)
				{
					this.global1.number_otvet = 4;
				}
				else if (this.global1.number_event == 438)
				{
					this.global1.number_otvet = 3;
				}
				else if (this.global1.number_event == 439)
				{
					this.global1.number_otvet = 6;
				}
				else if (this.global1.number_event == 445)
				{
					this.global1.number_otvet = 5;
				}
				else if (this.global1.number_event == 900)
				{
					this.global1.number_otvet = 1;
				}
				else
